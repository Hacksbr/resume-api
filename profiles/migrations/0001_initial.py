# Generated by Django 3.1.7 on 2021-10-03 02:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_link', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='profiles_profile_profile', to='profiles.sociallink', verbose_name='Social Link ')),
            ],
            options={
